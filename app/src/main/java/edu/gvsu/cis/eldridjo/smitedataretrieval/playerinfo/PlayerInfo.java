...
public class PlayerInfo {
    ...
    private edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedConquest RankedConquest;
    private edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedDuel RankedDuel;
    private edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedJoust RankedJoust;
    private int TeamId;
     ...
     */
    public PlayerInfo(String Avatar_URL, String Created_Datetime, int Id, String Last_Login_Datetime, int Leaves, int Level, int Losses, int MasteryLevel, String Name, int Rank_Stat_Conquest, int Rank_Stat_Duel, int Rank_Stat_Joust, edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedConquest RankedConquest, edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedDuel RankedDuel, edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedJoust RankedJoust, int TeamId, String Team_Name, int Tier_Conquest, int Tier_Duel, int Tier_Joust, int Total_Achievements, int Total_Worshippers, int Wins, Object ret_msg) {
     ...
     * The RankedConquest
     */
    public edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedConquest getRankedConquest() {
     ...
     * The RankedConquest
     */
    public void setRankedConquest(edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedConquest RankedConquest) {
        this.RankedConquest = RankedConquest;
    }
     ...
     * The RankedDuel
     */
    public edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedDuel getRankedDuel() {
        return RankedDuel;
    }
     ...
     * The RankedDuel
     */
    public void setRankedDuel(edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedDuel RankedDuel) {
        this.RankedDuel = RankedDuel;
    }
     ...
     * The RankedJoust
     */
    public edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedJoust getRankedJoust() {
        return RankedJoust;
    }
     ...
     * The RankedJoust
     */
    public void setRankedJoust(edu.gvsu.cis.eldridjo.smitedataretrieval.playerinfo.RankedJoust RankedJoust) {
        this.RankedJoust = RankedJoust;
    }
